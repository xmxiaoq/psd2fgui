 ...
 */
exports.convert = function (psdFile: string, outputFile: string, option: number, buildId?: string) {
...
function createImage(aNode, scale9Grid?: boolean) {
...
function createComponent(aNode, name?: string) {
...
function parseNode(aNode, rootNode, displayList, onElementCallback?: Function) {
    var child;
    var packageItem;
    var instProps;
    var str;
...
function convertToHtmlColor(rgbaArray, includingAlpha?: boolean) {
    var result = '#';
    var str;
    if (includingAlpha) {
